...
### CRM sévérités comonotones et fréquence indépendante
###
### Exemple :
### calculer_ES_comono_indep(dDistX = function(x) dpois(x, 3),
...
# E[S]
calculer_ES_comono_indep <- function(dDistX, qDistX, dDistN, qDistN)
{
