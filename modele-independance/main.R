...
###
###
### Exemples numériques avec le modèle 2
###
###
###
source("utilitaires/utilitaires.R")
source("modele-independance/echantillonner_modele_2.R")
source("modele-independance/calculer_ES.R")
source("modele-independance/calculer_fS.R")
...
# Var(S)
sum((seq(nfft) - 1)^2 * fs) - sum((seq(nfft) - 1) * fs)^2
var(S)
